(function (global, factory) {
	...
	(global = global || self, factory((global.widget = global.widget || {}, global.widget.select = {})));
	  ...
	  data: function data() {
	    ...
	    return {
	      selected: (function () {
	        ...
	        if (!this$1.multiple && Array.isArray(value)) {
	          return value[0];
	        }
	        return value;
	      })(),
	      options: map_1(JSON.parse(this.items), function (label, id) {
	...
	var __vue_render__ = function () {
	  ...
	  return _c(
	    ...
	    [
	      ...
	      _vm._v(" "),
	      _vm.hasSelected && _vm.multiple
	        ? _c(
	            "div",
	            _vm._l(_vm.selected, function (value) {
	              return _c("input", {
	      ...
	      _vm._v(" "),
	      _c("v-select", {
	        class: [_vm.className, _vm.focused ? "focused" : ""],
	        attrs: {
	          ...
	          deselectFromDropdown: _vm.deselectFromDropdown,
