(function (global, factory) {
	...
	var script = {
	  ...
	  computed: {
	    options: function () {
	      return map_1(JSON.parse(this.items), function (label, id) {
