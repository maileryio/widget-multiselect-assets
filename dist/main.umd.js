	    ...
	    data: function data() {
	      ...
	      return {
	        ...
	        options: (function () {
	          ...
	          return map_1(JSON.parse(this$1.items), function (label, id) {
