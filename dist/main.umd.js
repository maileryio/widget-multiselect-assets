(function (global, factory) {
	...
	var script = {
	  ...
	  data: function data() {
	    ...
	    return {
	      selected: (function () {
	        var value = this$1.value ? JSON.parse(this$1.value) : null;
